  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 3 }}>
        {/* Column 1: Name, Email, Password, Phone Number */}
        ...
        {/* Column 2: City, State, Country, Occupation */}
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
          {[
      ...
      {/* Role selection stretched across both columns */}
...
export default Signup; // Ensure this is at the end of the file